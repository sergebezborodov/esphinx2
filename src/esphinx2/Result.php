 ...
 */
class Result extends \yii\base\Component implements \Iterator, \ArrayAccess, \Countable
{
	/**
	 * @var array
	 */
    ...
    public function offsetGet($offset)
    {
        ...
        if (!isset($this->_match_objects[$offset])) {
            $this->_match_objects[$offset] = new MatchResult($this->_matches[$offset]);
        }
    ...
    {
        throw new Exception('Search result is readonly');
    }
